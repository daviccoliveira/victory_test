...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def go_to_pose_goal(self):
    ...
    pose_goal.orientation.x = -0.07393
    pose_goal.orientation.y = -0.078247
    pose_goal.orientation.z = -0.68278
    pose_goal.orientation.w = 0.72265
    pose_goal.position.x = 0.013168
    pose_goal.position.y = -0.2319
    pose_goal.position.z = 0.66382
